# Learn Content Skeleton

Content coming soon for the reorganized learn pages:

- /introduction — why this exists, what you'll learn, challenge mode
  - /introduction/problem — the problem and a naive baseline that fails
  - /introduction/scope — assumptions, scope, glossary
...
Content rule: if a page needs the bike model or friction circle, link to /core/plant-and-limits and include only a one-sentence recap plus a single symbol reference (no full equations).
