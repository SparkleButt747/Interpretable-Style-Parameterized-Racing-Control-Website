...
export default async function AppendixPage() {
  const res = await getStandaloneSection("appendix")
  const { frontmatter, content } = res

  return (
    <section className="mx-auto flex w-full max-w-3xl flex-col gap-6 py-12 text-center">
      <div className="space-y-4">
        <p className="text-sm uppercase tracking-widest text-primary">Appendix</p>
...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `${Settings.metadataBase}/appendix`,
    ...
    alternates: {
      canonical: `${Settings.metadataBase}/appendix`,
    },
  }
}
